...
-- Users (auth) and accounts (business) share the same id per demo login.
...
VALUES
    ('4a814ae2-5bc8-48d1-982c-95b6e6d14848', 'Alex',  'Demo',  'demo@example.com'),
    ('9487f2c3-c5b3-457d-a540-c50d3f4840e6', 'Jamie', 'Sales', 'sales2@example.com')
