...
src/app/
  ...
  features/
    ...
    system/      home page + 401 / 404 / generic error pages
  shared/
...
Frontend request/response interfaces intentionally mirror backend transport contracts
(`PaginationFilter`, `PaginationResponse<T>`, `AccountResponse`, `ContactResponse`,
`LoginResponse`, `RegisterResponse`) so API serialization remains explicit and consistent.
