...
- [`03-requirements-coverage.md`](03-requirements-coverage.md) — direct mapping from the
  brief's GenAI bullets to the docs in this repository, so the reviewer can verify
  coverage quickly.
